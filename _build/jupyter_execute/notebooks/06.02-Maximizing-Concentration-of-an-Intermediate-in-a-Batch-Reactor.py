...
# $$
# 
# where $A$ is a raw material and $C$ is an undesired by-product. The reaction operates isothermally with rate constants $k_A = 0.5\ \mbox{min}^{-1}$ and $k_A = 0.1\ \mbox{min}^{-1}$. The raw material is a solution with concentration $C_{A,f} = 2.0\ \mbox{moles/liter}$.
# 
