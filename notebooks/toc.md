...
### [6.4 Soft Landing a Rocket](http://nbviewer.jupyter.org/github/jckantor/ND-Pyomo-Cookbook/blob/master/notebooks/06.04-Soft-Landing-Apollo-11.ipynb]
- [Required Installations](http://nbviewer.jupyter.org/github/jckantor/ND-Pyomo-Cookbook/blob/master/notebooks/06.04-Soft-Landing-Apollo-11.ipynb#Required-Installations)
    - [Google Colab](http://nbviewer.jupyter.org/github/jckantor/ND-Pyomo-Cookbook/blob/master/notebooks/06.04-Soft-Landing-Apollo-11.ipynb#Google-Colab)
    - [Windows PC](http://nbviewer.jupyter.org/github/jckantor/ND-Pyomo-Cookbook/blob/master/notebooks/06.04-Soft-Landing-Apollo-11.ipynb#Windows-PC)
- [Python Initializations](http://nbviewer.jupyter.org/github/jckantor/ND-Pyomo-Cookbook/blob/master/notebooks/06.04-Soft-Landing-Apollo-11.ipynb#Python-Initializations)
- [Version 1: Vertical Dynamics of a Rocket with Constant Mass](http://nbviewer.jupyter.org/github/jckantor/ND-Pyomo-Cookbook/blob/master/notebooks/06.04-Soft-Landing-Apollo-11.ipynb#Version-1:-Vertical-Dynamics-of-a-Rocket-with-Constant-Mass)
    - [First attempt at a solution](http://nbviewer.jupyter.org/github/jckantor/ND-Pyomo-Cookbook/blob/master/notebooks/06.04-Soft-Landing-Apollo-11.ipynb#First-attempt-at-a-solution)
    - [Land on the surface, not above or below the surface.](http://nbviewer.jupyter.org/github/jckantor/ND-Pyomo-Cookbook/blob/master/notebooks/06.04-Soft-Landing-Apollo-11.ipynb#Land-on-the-surface,-not-above-or-below-the-surface.)
    - [Make that a soft landing.](http://nbviewer.jupyter.org/github/jckantor/ND-Pyomo-Cookbook/blob/master/notebooks/06.04-Soft-Landing-Apollo-11.ipynb#Make-that-a-soft-landing.)
    - [Restrict fuel flow to engine capacity.](http://nbviewer.jupyter.org/github/jckantor/ND-Pyomo-Cookbook/blob/master/notebooks/06.04-Soft-Landing-Apollo-11.ipynb#Restrict-fuel-flow-to-engine-capacity.)
- [Version 2: Rescaled Model](http://nbviewer.jupyter.org/github/jckantor/ND-Pyomo-Cookbook/blob/master/notebooks/06.04-Soft-Landing-Apollo-11.ipynb#Version-2:-Rescaled-Model)
    - [How much fuel is burned?](http://nbviewer.jupyter.org/github/jckantor/ND-Pyomo-Cookbook/blob/master/notebooks/06.04-Soft-Landing-Apollo-11.ipynb#How-much-fuel-is-burned?)
    - [Minimize fuel consumption.](http://nbviewer.jupyter.org/github/jckantor/ND-Pyomo-Cookbook/blob/master/notebooks/06.04-Soft-Landing-Apollo-11.ipynb#Minimize-fuel-consumption.)
- [Version 3: Rocket Model](http://nbviewer.jupyter.org/github/jckantor/ND-Pyomo-Cookbook/blob/master/notebooks/06.04-Soft-Landing-Apollo-11.ipynb#Version-3:-Rocket-Model)
* Links
